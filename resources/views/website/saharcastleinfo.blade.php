    ...
    @auth
        ...
        <section class="container mx-auto ">
            <div class="sohar-castleIamges row" style="margin-top: 100px">
                <div class="image col-12 col-sm-6 col-md-4 my-3">
                    <img src="{{ asset('assets/images/Sohar-Castle-1.AVIF') }}" class="card-img-top" alt="Sohar-Castle-1">
                </div>
                <div class="image col-12 col-sm-6 col-md-4 my-3">
                    <img src="{{ asset('assets/images/Sohar-Castle-2.AVIF') }}" class="card-img-top" alt="Sohar-Castle-1">
                </div>
                <div class="image col-12 col-sm-6 col-md-4 my-3">
                    <img src="{{ asset('assets/images/Sohar-Castle-3.AVIF') }}" class="card-img-top" alt="Sohar-Castle-1">
                </div>
            </div>
        </section>
