        ...
        <section class="container mx-auto ">
            <div class="sohar-castleIamges row" style="margin-top: 100px">
                <div class="image col-12 col-sm-6 col-md-4 my-3">
                    <img src="{{ asset('assets/images/mosque-img1.AVIF') }}" class="card-img-top" alt="mosque-img1">
                </div>
                <div class="image col-12 col-sm-6 col-md-4 my-3">
                    <img src="{{ asset('assets/images/mosque-img2.AVIF') }}" class="card-img-top" alt="mosque-img2">
                </div>
                <div class="image col-12 col-sm-6 col-md-4 my-3">
                    <img src="{{ asset('assets/images/mosque-img3.AVIF') }}" class="card-img-top" alt="mosque-img3">
                </div>
            </div>
        </section>
