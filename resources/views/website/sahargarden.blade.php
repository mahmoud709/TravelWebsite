        ...
        <section class="container mx-auto ">
            <div class="sohar-castleIamges row" style="margin-top: 100px">
                <div class="image col-12 col-sm-6 col-md-3 text-center my-3">
                    <img src="{{ asset('assets/images/garden1.AVIF') }}" alt="garden1">
                </div>
                <div class="image col-12 col-sm-6 col-md-3 text-center my-3">
                    <img src="{{ asset('assets/images/garden2.AVIF') }}" alt="garden2">
                </div>
                <div class="image col-12 col-sm-6 col-md-3 text-center my-3">
                    <img src="{{ asset('assets/images/garden3.AVIF') }}"alt="garden3">
                </div>
                <div class="image col-12 col-sm-6 col-md-3 text-center my-3">
                    <img src="{{ asset('assets/images/garden4.AVIF') }}"alt="garden4">
                </div>
            </div>
        </section>
